...
export const GEAR: GearItem[] = [
  // --- Knives & Cutting ---
  {
    ...
    url: 'https://www.amazon.com/s?k=victorinox+fibrox+8+inch+chef+knife&tag=manlymeals-20',
    price: '~$25',
    group: 'Knives & Cutting',
    bundle: true,
    tiers: [
      { label: 'Budget Option', name: 'Victorinox Fibrox 8"', price: '~$25', url: 'https://www.amazon.com/s?k=victorinox+fibrox+8+inch+chef+knife&tag=manlymeals-20' },
      { label: 'Solid / Mid-Tier', name: 'Mercer Genesis Forged', price: '~$55', url: 'https://www.amazon.com/s?k=mercer+genesis+8+inch+chef+knife&tag=manlymeals-20' },
      { label: 'Premium Option', name: 'Wüsthof Classic', price: '~$120', url: 'https://www.amazon.com/s?k=wusthof+classic+8+inch+chef+knife&tag=manlymeals-20' },
    ],
  },
  {
    name: 'Plastic Cutting Board (set of 2)',
    why: 'One for raw meat, one for everything else. Dishwasher safe.',
    url: 'https://www.amazon.com/s?k=oxo+good+grips+cutting+board+set&tag=manlymeals-20',
    price: '~$20',
    group: 'Knives & Cutting',
    bundle: true,
    tiers: [
      { label: 'Budget Option', name: 'OXO Good Grips (set of 2)', price: '~$20', url: 'https://www.amazon.com/s?k=oxo+good+grips+cutting+board+set&tag=manlymeals-20' },
      { label: 'Solid / Mid-Tier', name: 'OXO Carving Board w/ Groove', price: '~$35', url: 'https://www.amazon.com/s?k=oxo+carving+board+with+groove&tag=manlymeals-20' },
      { label: 'Premium Option', name: 'John Boos Maple Block', price: '~$90', url: 'https://www.amazon.com/s?k=john+boos+maple+cutting+board+block&tag=manlymeals-20' },
    ],
  },
  {
    name: 'Paring Knife',
    why: 'Small blade for the close work: garlic, peeling, trimming, deveining.',
    url: 'https://www.amazon.com/s?k=paring+knife+3.5+inch&tag=manlymeals-20',
    price: '~$10',
    group: 'Knives & Cutting',
  },
  ...
  // --- Cookware ---
  {
    ...
    url: 'https://www.amazon.com/s?k=lodge+12+inch+cast+iron+skillet&tag=manlymeals-20',
    price: '~$30',
    group: 'Cookware',
    bundle: true,
    tiers: [
      { label: 'Budget Option', name: 'Lodge 12" Cast Iron', price: '~$30', url: 'https://www.amazon.com/s?k=lodge+12+inch+cast+iron+skillet&tag=manlymeals-20' },
      { label: 'Solid / Mid-Tier', name: 'Lodge Chef Collection', price: '~$45', url: 'https://www.amazon.com/s?k=lodge+chef+collection+12+inch+cast+iron+skillet&tag=manlymeals-20' },
      { label: 'Premium Option', name: 'Smithey No. 12', price: '~$200', url: 'https://www.amazon.com/s?k=smithey+no+12+cast+iron+skillet&tag=manlymeals-20' },
    ],
  },
  {
    name: 'Stainless Steel Frying Pan',
    why: 'For eggs and anything delicate where cast iron is overkill.',
    url: 'https://www.amazon.com/s?k=tramontina+tri+ply+stainless+steel+frying+pan+10+inch&tag=manlymeals-20',
    price: '~$30',
    group: 'Cookware',
    bundle: true,
    tiers: [
      { label: 'Budget Option', name: 'Tramontina 10" Tri-Ply', price: '~$30', url: 'https://www.amazon.com/s?k=tramontina+tri+ply+stainless+steel+frying+pan+10+inch&tag=manlymeals-20' },
      { label: 'Solid / Mid-Tier', name: 'Cuisinart MultiClad Pro', price: '~$55', url: 'https://www.amazon.com/s?k=cuisinart+multiclad+pro+stainless+steel+skillet&tag=manlymeals-20' },
      { label: 'Premium Option', name: 'All-Clad D3', price: '~$130', url: 'https://www.amazon.com/s?k=all+clad+d3+stainless+steel+frying+pan&tag=manlymeals-20' },
    ],
  },
  {
